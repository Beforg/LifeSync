...
public class TabelaItensCard {
    ...
    final String PATH_CHECAR = "/images/ico/checked.png";
    final String PATH_CHECAR_PRESSED = "/images/ico/checked_pressed.png";
    final String PATH_DELETE = "/images/estudos/delete.png";
    final String PATH_DELETE_PRESSED = "/images/estudos/delete_pressed.png";
