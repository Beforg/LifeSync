...
public class Cronometro {
    ...
    private static final String STYLE_INTERVALO = "-fx-text-fill: rgba(149,212,237,0.54)";
    private static final String STYLE_INTERVALO_LONGO = "-fx-text-fill: #7accc5";
    ...
    private static void decrementarTempoPomodoro(TextField campoTempoPomodoro,Label labelIndicadoraPomodoro, Label labelPomodoro, Integer tempoBreakCurto, Integer tempoBreakLongo, Integer quantidadeCiclos) {
        if (playPause != 2) {
            if (tempoPomodoro == 0) {
                ...
                playPause++;
                timeline.stop();
                NotificacaoUtil.mostrarNotificacao("Pomodoro", "Pomodoro Concluído! Iniciando Intervalo", "INFO");
            ...
            NotificacaoUtil.mostrarNotificacao("Pomodoro", "Intervalo Concluído!", "INFO");
            NotificacaoUtil.tocarSom("/audio/done.mp3");
