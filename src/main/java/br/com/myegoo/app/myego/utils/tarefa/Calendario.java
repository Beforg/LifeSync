...
public class Calendario {
    public static final String styleSemana =  "-fx-background-color: linear-gradient(to bottom, #352f44, rgb(92, 84, 112));"+"-fx-border-color: rgb(92, 84, 112);" +
            "    -fx-border-width: 1px;" +
            "    -fx-background-radius: 5px;" +
            "    -fx-padding: 4px;" +
            "   -fx-text-fill: #ffffff;" +
            "    -fx-font-size: 15px;"+
            "    -fx-font-family: 'Yu Gothic UI';" +
            "  -fx-preferred-width: 100px;";

    private static final String style = "-fx-background-color: linear-gradient(to bottom, #352f44, rgb(92, 84, 112));"+"-fx-border-color: rgb(92, 84, 112);" +
            "    -fx-border-width: 1px;" +
            ...
            "    -fx-font-size: 12px;"+
            "    -fx-font-family: 'Yu Gothic UI';";
    private static final String styleDiaAtual = style;
    private static final String styleIndicadora = "-fx-background-color: linear-gradient(to bottom, #352f44, rgb(92, 84, 112));"+"-fx-border-color: rgb(92, 84, 112);" +
            "    -fx-border-width: 1px;" +
            ...
            "    -fx-font-family: 'Yu Gothic UI';" +
            "    -fx-min-width: 115px";
    private static final String styleHover = style +"-fx-background-color: rgba(107,115,70,0.75);";

    private static final String styleHoverSemana = styleSemana +"-fx-background-color: #6B7346BF";

    private static final String styleConcluido = "-fx-background-color: linear-gradient(to bottom, #352f44, rgb(92, 84, 112));"+"-fx-border-color: rgb(92, 84, 112);"+
            "    -fx-border-width: 1px;" +
            "    -fx-border-radius: 5px;" +
            "    -fx-background-radius: 5px;" +
            "    -fx-padding: 2px;" +
            ...
            "    -fx-font-family: 'Yu Gothic UI';" +
            "    -fx-font-size: 12px;";
    private static final String styleAtrasada = "-fx-background-color: linear-gradient(to bottom, #352f44, rgb(92, 84, 112));"+"-fx-border-color: rgb(92, 84, 112);" +
            "    -fx-border-width: 1px;" +
            "    -fx-border-radius: 5px;" +
            "    -fx-background-radius: 5px;" +
            "    -fx-padding: 2px;" +
    ...
    public static void setDiasSemana(Label muralSemanaTarefasSemana,
        ...
        label2.setStyle(styleSemana);
        label2.setOnMouseEntered(event -> label2.setStyle(styleHoverSemana));
        label2.setOnMouseExited(event -> label2.setStyle(styleSemana));
