        ...
        cbSelecionaProjetoMural.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
                ProjetoCardService.carregaCardsNoMural(naoIniciadas, emAndamento, concluidas, projetoCardRepository,
                        ...
                        naoIniciadasCount, emAndamentoCount,completoCount,diasRestantesProjetos,projetoRepository,colunaNome,pgProjetos,labelProgressoProjetos);
            } else {
                naoIniciadas.getChildren().clear();
                emAndamento.getChildren().clear();
                concluidas.getChildren().clear();
                naoIniciadasCount.setText("Não iniciadas");
                emAndamentoCount.setText("Em andamento");
                completoCount.setText("Concluídas");
            }
        });
    }
        ...
        cbMeusProjetos.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
                ...
                if (!cardsCarregados.isEmpty()) {
                    ...
                    } else if (totalDeCardsConcluidos < totalDeCards && totalDeCardsEmAndamento > 0 || totalDeCardsConcluidos > 0 ) {
            ...
            if (newValue != null) {
                ...
                if (newValue.equals("Não iniciado")) {
                    ...
                    ProjetoCardService.carregaCardsNoMural(naoIniciadas,emAndamento,concluidas,
                            ...
                            diasRestantesProjetos,projetoRepository,colunaNome,pgProjetos,labelProgressoProjetos);
                }
